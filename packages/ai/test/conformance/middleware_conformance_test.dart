...
void main() {
  group('middleware conformance', () {
    ...
    group('extractReasoningMiddleware', () {
      test('strips <think>...</think> and creates ReasoningPart in generate',
          () async {
        ...
        final reasoningParts =
            result.content.whereType<LanguageModelV3ReasoningPart>().toList();
        final textParts =
            result.content.whereType<LanguageModelV3TextPart>().toList();
      ...
      test('converts <think> text deltas to StreamPartReasoningDelta in stream',
          () async {
    ...
    group('extractJsonMiddleware', () {
      test('strips ```json ... ``` code fences from generate output', () async {
        ...
        final textPart =
            result.content.whereType<LanguageModelV3TextPart>().first;
