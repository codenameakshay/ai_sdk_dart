  ...
  group('registry conformance', () {
    ...
    group('createProviderRegistry()', () {
      ...
      test('resolves embedding model by provider:modelId string', () {
        final model = registry.textEmbeddingModel('fake:text-embedding-3-small');
      ...
      test('throws ArgumentError for unknown provider in textEmbeddingModel', () {
        expect(
      ...
      test('error message for unknown provider mentions available providers', () {
        try {
