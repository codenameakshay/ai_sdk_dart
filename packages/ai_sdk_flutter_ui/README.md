...
Flutter UI controllers for [AI SDK Dart](https://pub.dev/packages/ai) — the Dart/Flutter equivalent of the Vercel AI SDK React hooks (`useChat`, `useCompletion`, `useObject`).
